...
import { Shield, Zap, Lock, MapPin, Database } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="w-full h-full min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden text-white font-sans">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-500/5 blur-[120px] rounded-full pointer-events-none"></div>

      <div className="w-full max-w-md z-10 animate-fade-in relative">
         <div className="flex justify-center mb-8">
            <div className="relative">
              <Shield className="w-20 h-20 text-primary shadow-[0_0_30px_rgba(57,255,20,0.5)] rounded-full bg-black/50 backdrop-blur-md" strokeWidth={1} />
