...
const INITIAL_PROJECTS: Project[] = [
  { 
    ...
    location: 'Gujarat', type: 'Forestry', price: 2365, available: 18000, 
  ...
  { 
    ...
    location: 'Punjab', type: 'Tech/CCS', price: 3735, available: 5000, 
  ...
  { 
    ...
    location: 'Jharkhand', type: 'Renewable', price: 813, available: 125000, 
  ...
  { 
    ...
    location: 'Uttarakhand', type: 'Renewable', price: 930, available: 95000, 
  ...
  { 
    ...
    location: 'Madhya Pradesh', type: 'Forestry', price: 1162, available: 62000, 
  ...
  { 
    ...
    location: 'Delhi NCR', type: 'Tech/CCS', price: 2697, available: 8500, 
  ...
  { 
    ...
    location: 'Arunachal Pradesh', type: 'Forestry', price: 622, available: 200000, 
  ...
  { 
    ...
    location: 'Maharashtra', type: 'Tech/CCS', price: 7055, available: 3000, 
  ...
  { 
    ...
    location: 'Odisha', type: 'Community', price: 456, available: 320000, 
  ...
  { 
    ...
    location: 'Kerala', type: 'Forestry', price: 1307, available: 34000, 
  ...
  { 
    ...
    location: 'Gujarat', type: 'Tech/CCS', price: 20335, available: 1200, 
  ...
  { 
    ...
    location: 'Bihar', type: 'Community', price: 705, available: 150000, 
  ...
  { 
    ...
    location: 'Tamil Nadu', type: 'Renewable', price: 913, available: 89000, 
  ...
  { 
    ...
    location: 'West Bengal', type: 'Forestry', price: 1510, available: 12000, 
  ...
  { 
    ...
    location: 'Rajasthan', type: 'Renewable', price: 1037, available: 45000, 
    ...
    const unsubscribe = onSnapshot(q, async (snapshot) => {
      if (snapshot.empty && !isSeeding) {
        ...
        const liveProjects = snapshot.docs.map(doc => {
           ...
           if (data.price <= 300) {
              data.price = Math.round(data.price * 83);
           }
           return data;
        });
